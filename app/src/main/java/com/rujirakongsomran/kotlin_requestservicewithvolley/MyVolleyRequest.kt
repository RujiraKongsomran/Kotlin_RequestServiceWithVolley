    ...
    fun postRequest(url: String) {
        val postRequest = object : StringRequest(
            ...
            override fun getParams(): MutableMap<String, String> {
                ...
                params["name"] = "Rujira Kongsomran"
                params["value"] = "This is value posted from Android Spread"
                return params
            }
        }
    ...
    fun putRequest(url: String) {
        val putRequest = object : StringRequest(
            ...
            override fun getParams(): MutableMap<String, String> {
                val params = HashMap<String, String>()
                params["name"] = "Rujira Kongsomran"
                params["value"] = "This is value put from Android Spread"
                return params
            }
        }
    ...
    fun patchRequest(url: String) {
        val patchRequest = object : StringRequest(
            ...
            override fun getParams(): MutableMap<String, String> {
                val params = HashMap<String, String>()
                params["name"] = "Rujira Kongsomran"
                params["value"] = "This is value patch from Android Spread"
                return params
            }
        }
